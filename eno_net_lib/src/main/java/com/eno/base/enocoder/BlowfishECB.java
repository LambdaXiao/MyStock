...
/**
 * <p>Title: BlowfishECB 类</p>
 * <p>Description: Blowfish加密算法(ECB模式)</p>
...
public class BlowfishECB
{
	 ...
	 * @param ofs where to start reading
		...
		int len)
	{
		...
		for (i = 0; i < PBOX_ENTRIES;)
		{
			...
			this.pbox[i++] = ENOUtils.byteArrayToInt(this.block_buf, 0);
			this.pbox[i++] = ENOUtils.byteArrayToInt(this.block_buf, 4);
		}

		for (i = 0; i < SBOX_ENTRIES;)
		{
			encryptPrv(this.block_buf, 0, this.block_buf, 0, BLOCKSIZE);
			this.sbox1[i++] = ENOUtils.byteArrayToInt(this.block_buf, 0);
			this.sbox1[i++] = ENOUtils.byteArrayToInt(this.block_buf, 4);
		}

		for (i = 0; i < SBOX_ENTRIES;)
		{
			encryptPrv(this.block_buf, 0, this.block_buf, 0, BLOCKSIZE);
			this.sbox2[i++] = ENOUtils.byteArrayToInt(this.block_buf, 0);
			this.sbox2[i++] = ENOUtils.byteArrayToInt(this.block_buf, 4);
		}

		for (i = 0; i < SBOX_ENTRIES;)
		{
			encryptPrv(this.block_buf, 0, this.block_buf, 0, BLOCKSIZE);
			this.sbox3[i++] = ENOUtils.byteArrayToInt(this.block_buf, 0);
			this.sbox3[i++] = ENOUtils.byteArrayToInt(this.block_buf, 4);
		}

		for (i = 0; i < SBOX_ENTRIES;)
		{
			encryptPrv(this.block_buf, 0, this.block_buf, 0, BLOCKSIZE);
			this.sbox4[i++] = ENOUtils.byteArrayToInt(this.block_buf, 0);
			this.sbox4[i++] = ENOUtils.byteArrayToInt(this.block_buf, 4);
		}
	 ...
	 * @param inpos where to start reading the plaintext data
	 * @param outbuf buffer to put the ciphertext data
	 * @param outpos where to start writing the ciphertext data
...
*/
	 ...
	 * @param inpos where to start reading the ciphertext data
	 * @param outbuf buffer to put the plaintext data
	 * @param outpos where to start writing the plaintext data
