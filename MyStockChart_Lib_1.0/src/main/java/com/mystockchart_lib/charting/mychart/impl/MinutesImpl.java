...
public class MinutesImpl {
    ...
    public MinutesImpl(Context context,int exchid,MyLineChart lineChart, MyBarChart barChart){
...
//        xAxisLine.setLabelsToSkip(59);
        ...
        axisLeftLine.setLabelCount(3, true);//标写多少个Y轴刻度值
        axisLeftLine.setDrawLabels(true);//是否显示Y轴刻度值
        axisLeftLine.setDrawGridLines(false);//画里面的网格线
        axisLeftLine.setDrawAxisLine(false);/*轴不显示 避免和border冲突*/
        axisLeftLine.setPosition(YAxis.YAxisLabelPosition.INSIDE_CHART);//坐标在y轴里面
        ...
        axisRightLine.setLabelCount(1, true);//标写中点上下方各多少个Y轴刻度值
        axisRightLine.setDrawLabels(true);
        axisRightLine.setPosition(YAxis.YAxisLabelPosition.INSIDE_CHART);//坐标在y轴里面
        ...
        xAxisBar.setDrawAxisLine(false);//轴线
        ...
        axisLeftBar.setPosition(YAxis.YAxisLabelPosition.INSIDE_CHART);//坐标在y轴里面
        //右 y 轴
    ...
    private SparseArray<String> setXLabels() {
        ...
        switch (exchid){
            ...
            case Consts.MARKET_SH:
                mMaxDataLength = Consts.MAXCYD_SH_SZ/Consts.FSDATA_FREG+1;
                xLabels.put(0, "09:30");
            ...
            case Consts.MARKET_HK:
                mMaxDataLength = Consts.MAXCYD_HK/Consts.FSDATA_FREG+1;
                xLabels.put(0, "09:30");
