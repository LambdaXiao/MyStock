...
public class MinutesLandImpl {
    ...
    public MinutesLandImpl(Context context, int exchid, MyLineChart lineChart, MyBarChart barChart) {
    ...
    private void initChart() {
        ...
        xAxisLine.setDrawGridLines(true);//画里面的网格线
