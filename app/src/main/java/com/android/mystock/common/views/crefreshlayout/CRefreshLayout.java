...
public class CRefreshLayout extends ViewGroup{
	...
	public void init(Context context){
		setBackgroundColor(ContextCompat.getColor(context, R.color.windowsbackground));
...
//                    float adjustedPercent = dragPercent;
                ...
                if(mRefreshView.state == CRefreshView.CRefreshLayoutState.CRefreshLayoutStateIdle){
            ...
            case MotionEvent.ACTION_CANCEL: {
                ...
                if (overscrollTop > mTotalDragDistance) {
                	mRefreshView.state = CRefreshView.CRefreshLayoutState.CRefreshLayoutStateRefreshing;
    ...
    private Animation.AnimationListener mToStartListener = new Animation.AnimationListener() {
        ...
        @Override
        public void onAnimationEnd(Animation animation) {
        	mRefreshView.state = CRefreshView.CRefreshLayoutState.CRefreshLayoutStateIdle;
            mCurrentOffsetTop = mTarget.getTop();
        }
    };
