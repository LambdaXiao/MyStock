package com.android.mystock.common.views.smartisanpull;
 ...
 * Scrollview锤子下拉效果
 */
public class SmartisanRefreshableScrollview extends LinearLayout {
    ...
    public SmartisanRefreshableScrollview(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        if (changed && !mIsLayoutLoaded) {
            ...
            mListView = (ScrollView) getChildAt(1);       //这句需要改进

            mListDividerHeight = 1;//mListView.getDividerHeight();
            this.setBackgroundColor(context.getResources().getColor(R.color.windowsbackground));       //把背景统一设置为白色
    ...
    public boolean onInterceptTouchEvent(MotionEvent event) {
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE: {
                ...
                if(firstChildView == null || (firstChildView != null &&mListView.getScrollY()==0)){  //万事俱备，只欠下拉。
    ...
    private void updateLayoutAndText(){
        ...
        switch (mCurrentStatus){
            ...
            case RefreshStatus.STATUS_REFRESHING:
                mDescriptionTextView.setText("正在刷新...");
                mDescriptionTextView.setTextColor(Color.argb(255,120,120,120));
                break;
