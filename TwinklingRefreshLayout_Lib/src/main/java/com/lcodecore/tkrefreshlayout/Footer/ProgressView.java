...
public class ProgressView extends View{
    //indicators
    public static final int BallPulse=0;//三个点闪动
    public static final int BallGridPulse=1;//九个点闪动
    public static final int BallClipRotate=2;//大小圆旋转
    public static final int BallClipRotatePulse=3;//大小圆旋转,一个实心一个空心
    public static final int SquareSpin=4;//矩形翻转
    public static final int BallClipRotateMultiple=5;//类似大小圆旋转
    public static final int BallPulseRise=6;//五个点翻转
    public static final int BallRotate=7;//三个点一条线旋转
    public static final int CubeTransition=8;//两个小矩形点旋转
    public static final int BallZigZag=9;//两个小圆旋转
    public static final int BallZigZagDeflect=10;//类似两个小圆旋转
    public static final int BallTrianglePath=11;//三个点成三角形线旋转
    public static final int BallScale=12;//圆点扩散
    public static final int LineScale=13;//五竖长短变化
    public static final int LineScaleParty=14;//四竖长短变化
    public static final int BallScaleMultiple=15;//类似圆点扩撒
    public static final int BallPulseSync=16;//三个点跳动
    public static final int BallBeat=17;//类似三个点闪动
    public static final int LineScalePulseOut=18;//类似五竖长短变化
    public static final int LineScalePulseOutRapid=19;//类似五竖长短变化
    public static final int BallScaleRipple=20;//圆环扩散
    public static final int BallScaleRippleMultiple=21;//多圆环扩散
    public static final int BallSpinFadeLoader=22;//一圈圆点闪动
    public static final int LineSpinFadeLoader=23;//一圈短条闪动
    public static final int TriangleSkewSpin=24;//三角形翻转
    public static final int Pacman=25;//张口出圆点动画
    public static final int BallGridBeat=26;//类似九个点闪动
    public static final int SemiCircleSpin=27;//扇形旋转
